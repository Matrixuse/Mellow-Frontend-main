...
const UserProfilePage = () => {
    ...
    return (
        <div className="flex-1 flex flex-col h-full min-h-0 min-w-0 bg-gray-900">
            <div className="p-6 border-b border-gray-700 bg-gray-800/30 flex items-center justify-between">
                <div>
                ...
                {!isMe && token && (
                    <button
                        ...
                        className={`px-4 py-2 rounded-full text-white ${isFollowing ? 'bg-red-600' : 'bg-blue-600'}`}
