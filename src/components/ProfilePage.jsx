    ...
    return (
        <div className="flex-grow p-4 flex flex-col min-h-0 min-w-0">
            ...
            <div className="flex items-center gap-4 mb-6 flex-shrink-0">
                <Link to="/" className="p-2 rounded-full bg-[#1f1f1f] hover:bg-[#282828]">
                    <ArrowLeft size={24} />
                </Link>
            ...
            {/* User Info */}
            <div className="bg-[#1f1f1f]/50 rounded-lg p-6 mb-6">
            ...
            <div className="space-y-3">
                <Link 
                    to="/" 
                    className="flex items-center gap-4 p-4 bg-[#1f1f1f]/50 hover:bg-[#282828]/50 rounded-lg transition-colors"
                >
                ...
                <button 
                    onClick={onShowQueue}
                    className="flex items-center gap-4 p-4 bg-[#1f1f1f]/50 hover:bg-[#282828]/50 rounded-lg transition-colors w-full text-left"
                >
                ...
                {isLogoutVisible && (
                    <div className="ml-16 p-3 bg-blue-900/20 border border-red-900/50 rounded-lg">
